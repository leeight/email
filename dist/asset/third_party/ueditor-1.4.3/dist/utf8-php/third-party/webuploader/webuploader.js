(function (root, factory) {
    ...
    define('widgets/widget', [
        ...
        var $ = Base.$, _init = Uploader.prototype._init, IGNORE = {}, widgetClass = [];
        ...
        $.extend(Uploader.prototype, {
            _init: function () {
                var me = this, widgets = me._widgets = [];
            ...
            request: function (apiName, args, callback) {
                var i = 0, widgets = this._widgets, len = widgets.length, rlts = [], dfds = [], widget, rlt, promise, key;
    ...
    define('widgets/filepicker', [
        ...
        return Uploader.register({
            ...
            addButton: function (pick) {
                var me = this, opts = me.options, accept = opts.accept, options, picker, deferred;
                if (!pick) {
                    return;
                }
    ...
    define('widgets/image', [
        ...
        return Uploader.register({
            ...
            compressImage: function (file) {
                var opts = this.options.compress || this.options.resize, compressSize = opts && opts.compressSize || 300 * 1024, image, deferred;
                file = this.request('get-file', file);
    ...
    define('widgets/queue', [
        ...
        return Uploader.register({
            ...
            acceptFile: function (file) {
                var invalid = !file || file.size < 6 || this.accept && rExt.exec(file.name) && !this.accept.test(file.name);
                return !invalid;
            },
    ...
    define('widgets/upload', [
        ...
        function CuteFile(file, chunkSize) {
            var pending = [], blob = file.source, total = blob.size, chunks = chunkSize ? Math.ceil(total / chunkSize) : 1, start = 0, index = 0, len;
            while (index < chunks) {
        ...
        Uploader.register({
            ...
            _nextBlock: function () {
                var me = this, act = me._act, opts = me.options, next, done;
    ...
    define('widgets/validator', [
        ...
        api.addValidator('fileNumLimit', function () {
            var uploader = this, opts = uploader.options, count = 0, max = opts.fileNumLimit >> 0, flag = true;
            if (!max) {
                return;
            }
        ...
        api.addValidator('fileSizeLimit', function () {
            var uploader = this, opts = uploader.options, count = 0, max = opts.fileSizeLimit >> 0, flag = true;
            if (!max) {
                return;
            }
            uploader.on('beforeFileQueued', function (file) {
    ...
    define('runtime/html5/runtime', [
        ...
        function Html5Runtime() {
            var pool = {}, me = this, destory = this.destory;
    ...
    define('runtime/html5/dnd', [
        ...
        return Html5Runtime.register('DragAndDrop', {
            ...
            _dropHandler: function (e) {
                var me = this, ruid = me.getRuid(), parentElem = me.elem.parent().get(0);
                if (parentElem && !$.contains(parentElem, e.currentTarget)) {
                    return false;
                }
            ...
            _getTansferFiles: function (e, callback) {
                var results = [], promises = [], items, files, dataTransfer, file, item, i, len, canAccessFolder;
                e = e.originalEvent || e;
    ...
    define('runtime/html5/filepicker', [
        ...
        return Html5Runtime.register('FilePicker', {
            init: function () {
                var container = this.getRuntime().getContainer(), me = this, owner = me.owner, opts = me.options, lable = $(document.createElement('label')), input = $(document.createElement('input')), arr, i, len, mouseHandler;
    ...
    define('runtime/flash/runtime', [
        ...
        function FlashRuntime() {
            var pool = {}, clients = {}, destory = this.destory, me = this, jsreciver = Base.guid('webuploader_');
            Runtime.apply(me, arguments);
            me.type = type;
            me.exec = function (comp, fn) {
                var client = this, uid = client.uid, args = Base.slice(arguments, 2), instance;
        ...
        return FlashRuntime.register('Transport', {
            ...
            _initAjax: function () {
                ...
                xhr.on('load', function () {
                    var status = xhr.exec('getStatus'), err = '';
                    xhr.off();
                    me._xhr = null;
