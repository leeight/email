!function (a, b) {
    var c, d = {}, e = function (a, b) {
            ...
            'function' == typeof b && (c.length || (c = [
                ...
                g.exports,
                g
            ]), f = b.apply(null, c), void 0 !== f && (g.exports = f)), d[a] = g.exports;
        }, h = function (b) {
            var c = d[b] || a[b];
            if (!c)
    ...
    return b('dollar-third', [], function () {
        ...
        return d.extend(b.options, {
            ...
            addButton: function (b) {
                ...
                if (b)
                    return g = a.Deferred(), d.isPlainObject(b) || (b = { id: b }), e = d.extend({}, b, {
        ...
        return c.ExifMap = function () {
            ...
            if (o.ascii) {
                for (m = '', l = 0; l < k.length && (n = k[l], '\0' !== n); l += 1)
                    m += n;
                return m;
            }
            return k;
        ...
        function a(a) {
            ...
            function j(a, b) {
                ...
                for (k = 0; m > k; ++k) {
                    ...
                    var B = 0.382683433 * (w - z), C = 0.5411961 * w + B, D = 1.306562965 * z + B, E = 0.707106781 * y, G = p + E, H = p - E;
                ...
                for (l = 0, k = 0; m > k; ++k) {
                    ...
                    var V = 0.382683433 * (Q - T), W = 0.5411961 * Q + V, X = 1.306562965 * T + V, Y = 0.707106781 * S, Z = J + Y, $ = J - Y;
            ...
            function r(a) {
                if (0 >= a && (a = 1), a > 100 && (a = 100), x != a) {
                    var c = 0;
                    c = Math.floor(50 > a ? 5000 / a : 200 - 2 * a), b(c), x = a;
                }
            }
            function s() {
                a || (a = 50), q(), d(), e(), f(), r(a);
        ...
        return b.register('Image', {
            ...
            _resize: function (a, b, c, d) {
                ...
                ~[
                    ...
                    7,
                    8
                ].indexOf(m) && (c ^= d, d ^= c, c ^= d), e = Math[j.crop ? 'max' : 'min'](c / k, d / l), j.allowMagnify || (e = Math.min(1, e)), f = k * e, g = l * e, j.crop ? (b.width = c, b.height = d) : (b.width = f, b.height = g), h = (b.width - f) / 2, i = (b.height - g) / 2, j.preserveHeaders || this._rotate2Orientaion(b, m), this._renderImageToCanvas(b, a, h, i, f, g);
            },
