define('bat-ria/mvc/FormAction', [
    ...
    FormAction.prototype.submitEdit = function () {
        ...
        require('er/Deferred').when(this.beforeValidate(submitData)).then(u.bind(this.validate, this, submitData)).then(u.bind(this.afterValidate, this, submitData)).then(u.bind(this.submit, this, submitData)).ensure(u.bind(this.view.enableSubmit, this.view));
    };
